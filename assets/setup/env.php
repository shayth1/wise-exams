...
if (!defined('APP_NAME'))                       define('APP_NAME', 'Exami');
if (!defined('APP_ORGANIZATION'))               define('APP_ORGANIZATION', 'WISE');
if (!defined('APP_OWNER'))                      define('APP_OWNER', 'Aiah Oleimat');
if (!defined('APP_DESCRIPTION'))                define('APP_DESCRIPTION', 'exams portal');

if (!defined('ALLOWED_INACTIVITY_TIME'))        define('ALLOWED_INACTIVITY_TIME', time() + 1 * 60);

if (!defined('DB_DATABASE'))                    define('DB_DATABASE', 'gaint');
